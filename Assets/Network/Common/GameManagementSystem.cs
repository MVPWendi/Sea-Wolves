...
public partial class GameManagementSystem : SystemBase
{
    ...
    protected override void OnCreate()
    {
        ...
        RequireForUpdate<GameResourcesAuthorings>();
    ...
    private void ProcessHostRequests(ref Singleton singleton, ref EntityCommandBuffer ecb, GameResourcesAuthorings gameResources)
    {
        ...
        foreach (var (request, entity) in SystemAPI.Query<RefRO<HostRequest>>().WithEntityAccess())
        {
            ...
            {
                // Create server world
                ServerWorld = AutoConnectBootstrap.CreateServerWorld("ServerWorld");
    ...
    private void ProcessJoinRequests(ref Singleton singleton, ref EntityCommandBuffer ecb, GameResourcesAuthorings gameResources)
    {
        ...
        foreach (var (request, entity) in SystemAPI.Query<RefRO<JoinRequest>>().WithEntityAccess())
        {
            ...
            {
                // Create client world
                ClientWorld = AutoConnectBootstrap.CreateClientWorld("ClientWorld");
